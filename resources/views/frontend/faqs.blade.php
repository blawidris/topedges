 ...
 <div class="card card-4">
   ...
   <div class="card-header" role="tab" id="headingThree31">
     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#collapseThree31" aria-expanded="false" aria-controls="collapseThree31">
       <h5 class="mb-0">
         How long does it takes to withdraw? <i class="fas fa-angle-down rotate-icon" style="float: right;"></i>
       </h5>
     </a>
   </div>
...
<p>* coynarb Passive Income: Investors trades a minimum of $100, this will be engaged by our Arbitrage Trading Bot to generate return 1% daily compounded ROI.</p> </div>
   ...
   <div id="collapseFour41" class="collapse" role="tabpanel" aria-labelledby="headingFour41" data-parent="#accordionEx1">
     <div class="card-body text-black-50">
      click on the Mining Wall, the click on MINE to get daily Profit.

         <h6><b>* Are there loses in arbitrage?</b></h6>

<p>- Arbitrage Trading doesn't loss it only generate little profits but if compounded, it becomes meaningful.</p>
     </div>
   </div>
