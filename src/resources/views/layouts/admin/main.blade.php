...
<head>
    ...
    <link href="{{ asset('admin/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('admin/plugins/custom/vis-timeline/vis-timeline.bundle.css') }}" rel="stylesheet"
        type="text/css" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                        ...
                        <div class="app-navbar flex-shrink-0 ms-auto">
                            ...
                            <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                    ...
                                    <img src="{{ asset('admin/media/avatars/300-1.jpg') }}" alt="user" />
                                </div>
    ...
    <script src="{{asset('admin/plugins/custom/vis-timeline/vis-timeline.bundle.js')}}"></script>
